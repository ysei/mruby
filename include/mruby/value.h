...
#define paint_partial_white(s, o) ((o)->color = (s)->gc_context->current_white_part)
...
#define flip_white_part(s) ((s)->gc_context->current_white_part = other_white_part(s))
#define other_white_part(s) ((s)->gc_context->current_white_part ^ MRB_GC_WHITES)
